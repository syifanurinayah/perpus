	...
	$(function(){
		...
		$("#simpan").click(function(){
			...
			if (nis==""){
				...
				alert("Pilih Buku yang dipinjam");
				return false;
			}else{
				$.ajax({
	...
	<div class="panel-body">
		<form class="form-horizontal" action="<?php  echo site_url('peminjaman/simpan');?>" method="post">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-lg-4 control-label">Tgl peminjaman</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					...
					<div class="col-lg-7">
						<input type="text" id="kemabli" name="kembali" class="form-control" value="<?php echo $tanggalkembali;?>" readonly="readonly">
					</div>
				</div>
			</div>
...
<div class="panel panel-success">
	...
	<div class="panel-body">
		<div class="form-inline">
			...
			<div class="form-group">
				<label class="sr-only">Pengarang</label>
				<button id="tambah" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i></button>
			</div>
		</div>
	</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn btn-primary" id="konfirmasi">Hapus</button>
					</div>
				</div><!--MODAL CONTENT-->
			</div><!--MODAL DIALOG-->
		</div><!--MODAL-->